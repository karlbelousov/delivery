      ...
      <div class="products-wrapper">
        ...
        >
          <div class="product-card__image">
            <img :src="getUrl(rest.image)" alt="rests-1" />
          </div>
          <div class="product-card__description">
            <div class="product-card__description-row">
              <h4 class="product-card__description--title">{{ rest.title }}</h4>
              <div class="product-card__description--badge">{{ rest.time }} мин</div>
            </div>
            <div class="product-card__description-row">
              <div class="product-card__description-info">
                ...
                <div class="product-card__description-info--group">{{ rest.type }}</div>
              </div>
            </div>
          </div>
        </router-link>
